...
public class LocationController {
    ...
    public Map<String, String> getGeo(String completeAddress){
        try {
            String API_KEY = "AIzaSyB4kf0kp_LkThDqtZ-rwqBVxGwzaoVEkJ0";
            String surl = "https://maps.googleapis.com/maps/api/geocode/json?address="+ URLEncoder.encode(completeAddress, StandardCharsets.UTF_8)+"&key="+API_KEY;
